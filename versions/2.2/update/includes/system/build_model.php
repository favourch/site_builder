...
util::cliDisplay('Building models...');
$html = 'Building models...<br />
...
";
	...
	util::cliDisplay("$filename created.");
	$html .= "$filename created.<br />\r\n";
...
";
		...
		util::cliDisplay("$filename exists.");
		$html .= "$filename exists.<br />\r\n";
	}
	/**** END EXTENDED MODEL CLASS FILE ****/
}

util::cliDisplay('Done building models.');
$html .= "</div>\r\nDone.<br />\r\n";
