...
define('DATA_MODELER_VERSION', '2.5');
...
class base_dm extends data_util
{
	...
	function connectDb($dbInfo=null)
	{
		...
		$this->db = new db($this->dbInfo->host(), $this->dbInfo->user(), $this->dbInfo->pass(), $this->dbInfo->name(), $this->dbInfo()->debug());
	}

	function setDbDebug($debug=null)
	{
		if($this->db) {
